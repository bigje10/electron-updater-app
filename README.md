...
## Try it
The latest version of this example is `1.0.2`. So, you can download the [`1.0.1`](https://github.com/bigje10/electron-updater-app/releases/tag/v1.0.1) one and see how the app finds the new version and downloads it.


## To begin

```bash
$ git clone https://github.com/bigje10/electron-updater-app.git
...
- [Configure package.json](#configure-packagejson)
  - build > publish
- [Release](#release):
  - Create a [realease](https://github.com/bigje10/electron-updater-app/releases)
...
```yml
appId: com.bigje10.electron-updater-app
publish:
  provider: github
  owner: bigje10
...
<table>
  <tr>
    <td>
      <img src="https://github.com/bigje10.png?s=100" width="100"/>
    </td>
    <td>
      Natan Cabral<br />
      <a href="mailto:bigje10@hotmail.com">bigje10@hotmail.com</a><br />
      <a href="https://github.com/bigje10/">https://github.com/bigje10/</a>
    </td>
  </tr>
</table>
